...
android {
    namespace = "com.example.stockdecision"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.stockdecision"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
        ...
        val alphaVantageApiKey: String = project.findProperty("ALPHA_VANTAGE_API_KEY") as? String ?: "YOUR_API_KEY_HERE"
